...
""" files """
input_path = "../input/images/cat.png"
name = os.path.splitext(input_path)[0]

""" style on scpecific area """
frame = cv2.imread(input_path)
seg = cv2.imread("/media/gael/Space/PycharmProjects/StyleSegments/output/segmentations/cat_VOC.png")
style = cv2.imread("/media/gael/Space/PycharmProjects/StyleSegments/output/stylized/cat.jpg_cartoon.png")
